\chapter{Configuration and schema reference}
\label{app:config}

\section{Minimal economic-geography configuration}
...
\section{Congestion specification}
...
\subsection*{Mode-level edge congestion}
\begin{lstlisting}
[congestion]
specification = "edge"
[congestion.edge]
...
\subsection*{Edge-specific congestion}
\begin{lstlisting}
[congestion]
specification = "edge"
source = "input_column"
...
\subsection*{Endpoint-terminal congestion}
\begin{lstlisting}
[congestion]
...
\subsection*{Composite congestion}
\begin{lstlisting}
[congestion]
...
\section{Economic-geography node schema}

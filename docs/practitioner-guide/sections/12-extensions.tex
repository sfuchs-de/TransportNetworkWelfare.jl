\section{Extensions: urban commuting, terminals, and Seattle}
\label{ch:extensions}

\subsection{One transport block, different spatial closures}
...
\subsection{Seattle multimodal candidate}
...
\subsection{What remains empirical work}

...
The domestic and foreign nodes play different economic roles. The 228 domestic
locations enter labor mobility and the U.S. welfare criterion. The six foreign
regions remain in the transport recursion, but their import-supply and
export-demand schedules are held fixed. They do not enter the mobility
condition or receive weight in welfare.

This boundary condition also changes the interpretation of the Traditional
statistic. Proposition~1 applies to the integrated-economy benchmark used in
the theory. Once foreign schedules are fixed and welfare is restricted to U.S.
residents, a boundary-incidence term can remain even without domestic
externalities or congestion. The empirical decomposition reports this term
separately rather than attributing it to spatial externalities.

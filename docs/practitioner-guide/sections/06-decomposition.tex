\section{Exact closure and welfare decompositions}
\label{ch:decomposition}

\subsection{Common-baseline comparisons}
...
\subsection{Normalized multipliers}
...
\subsection{Inverse-gap identity}
...
\subsection{Analytical Jacobian blocks}
...
\subsection{Physical-link aggregation}
...
\subsection{Reading a decomposition}

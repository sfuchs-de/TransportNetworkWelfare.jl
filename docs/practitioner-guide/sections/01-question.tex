\section{Policy experiment and scope}
\label{ch:question}
...
\citet{Fogel1964Railroads}. It is simple, data-light, and often informative. It also
allows routes, modes, prices, and locations to adjust only implicitly.
Adjustment by itself does not invalidate social savings. The relevant question
is whether those responses change exposure to congestion or spatial
externalities that give reallocation a first-order welfare value.
...
\subsection{Scope of the measured benefits}
...
The quick start in Section \ref{ch:quickstart} implements this scope as a

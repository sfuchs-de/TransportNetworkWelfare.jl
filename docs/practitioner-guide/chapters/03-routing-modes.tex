\chapter{Recursive routes, modes, and congestion}
\label{ch:routing}

\section{From paths to a recursion}
...
\section{Recovering the baseline route object}
...
\section{Choice-consistent modal aggregation}

...
planar economic geographies. The body and head carry most economic activity.
...
The geometry and data were written for this package. They do not use the
Mathematica `ExampleData` cow mesh or any external image asset.
...
python plots/network_example.py \
  ...
  --metric primitive_F --transparent
```
